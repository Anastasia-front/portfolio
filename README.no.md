**Dokumentasjon på [engelsk 🇺🇸](README.md)** og [ukrainsk 🇺🇦](README.ua.md)

<hr/><hr/>

# Min portefølje

Dette nettstedet er min portefølje og inneholder mye informasjon om meg som utvikler og mine prosjekter.

## Innhold

- [Prosjektoversikt](#prosjektoversikt)
- [Teknologier og biblioteker brukt](#teknologier-og-biblioteker-brukt)
- [Implementert funksjonalitet i prosjektet](#implementert-funksjonalitet-i-prosjektet)
- [Mockups](#mockups)
- [Skjermbilder](#skjermbilder)
- [Standard dokumentasjon for Next.js](#standard-dokumentasjon-for-nextjs)
  - [Komme i gang](#komme-i-gang)
  - [Lær mer](#lær-mer)
  - [Distribuer på Vercel](#distribuer-på-vercel)

## Prosjektoversikt

Med dette nettstedet kan du bli kjent med mine ferdigheter, sertifikater og kontakte meg ved å sende en e-post via et skjema.

## Teknologier og biblioteker brukt

Prosjektet er implementert med følgende teknologier og biblioteker:
...
## Implementert funksjonalitet i prosjektet

- SEO
- Navigasjon på nettstedet
- Temabytting
- Responsivt design
- Ulike bildegallerier/slidere
- Forbedret tilgjengelighet
- Optimalisert lasting av ressurser
- Lokalisering og internasjonalisering (L10n og i18n)
- Skjemainnsending med validering
- Enkel innholdsstyring (all tekst er i lang.json-filer)

## Mockups

![hjemmeside](/public/mockups/home.webp)  
![om-side](/public/mockups/about.webp)  
![ferdigheter-side](/public/mockups/skills.webp)  
![prosjekter-side](/public/mockups/projects.webp)  
![kontaktside](/public/mockups/contacts.webp)

## Skjermbilder

![hjemmeside](/public/images/opengraph/en/home.webp)  
![om-side](/public/images/opengraph/en/about.webp)  
![ferdigheter-side](/public/images/opengraph/en/skills.webp)  
![prosjekter-side](/public/images/opengraph/en/projects.webp)  
![kontaktside](/public/images/opengraph/en/contacts.webp)

# Standard dokumentasjon for Next.js

Dette er et [Next.js](https://nextjs.org/)-prosjekt laget med [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
